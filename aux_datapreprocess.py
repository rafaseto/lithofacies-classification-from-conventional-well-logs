...
# Modelo da func. nova
def nphi_transform(dlis_df, indexes):
    for i in indexes:
        dlis_df[i]["NPHI"] *= 100
...
pontos_com_falha = [
    (dataframes[0]['profundidade '] < 250) | (dataframes[0]['profundidade '] >= 360),
    (dataframes[1]['profundidade '] <= 75) | (dataframes[1]['profundidade '] >= 210),
    (dataframes[2]['profundidade '] <= 60) | (dataframes[2]['profundidade '] >= 260),
    (dataframes[3]['profundidade '] <= 90) | (dataframes[3]['profundidade '] >= 300),
    (dataframes[4]['profundidade '] <= 64) | (dataframes[4]['profundidade '] >= 215),
    (dataframes[5]['profundidade '] <= 90) | (dataframes[5]['profundidade '] >= 320)
]
